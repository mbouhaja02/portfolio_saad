...
const certificates = [
  
  {
    ...
    date: 'déc. 2023',
    expires: 'déc. 2025',
    credentialId: '8236', // adapte si besoin (format vu sur capture)
    skills: ['English Proficiency', 'Academic'],
    logo: 'https://upload.wikimedia.org/wikipedia/commons/6/61/IELTS_logo.svg',
    // pdf: pdfIELTS,
  },
];
